...
class PracticeSurvey(models.Model):
...
class PracticeAnswer(models.Model):
    ...
    survey_idx = models.ForeignKey("PracticeSurvey", related_name="PracticeSurvey", on_delete=models.CASCADE, db_column="survey_idx")
